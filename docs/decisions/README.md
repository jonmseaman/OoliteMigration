...
| [0039](0039-oofnd-scanner.md) | `oo::str::Scanner` / `CharacterSet` reproduce NSScanner's skipping, case-insensitive matching and failure locations and GNUstep's set tables; `NSScannerOOExtensions` retired; GNUstep's nil-string scanner diagnostic dropped | Proposed — default in effect |
